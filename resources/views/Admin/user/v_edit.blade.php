            ...
            <form action="/user/update/{{ $user->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label>E-mail</label>
                            <input type="text" name="email" class="form-control" value="{{ $user->email }}" placeholder="E-mail" readonly>
                            <div class="text-danger">
                                @error('email')
                                {{$message}}
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="password" class="form-control" value="{{ $user->password }}" placeholder="Password" readonly>
                            <div class="text-danger">
                                @error('password')
                                {{$message}}
                                @enderror
